 ...
 *
 * Backported from SOLR 5x by OSC in Feb 2021
 */
...
public final class BoostQuery extends Query {
    ...
    public Weight createWeight(IndexSearcher searcher) throws IOException {
        ...
        return new Weight() {
            ...
            @Override
            public Scorer scorer(AtomicReaderContext context, boolean inOrder, boolean topScorer, Bits bits) throws IOException {
                return weight.scorer(context, inOrder, topScorer, bits);
            }
        };
    }
