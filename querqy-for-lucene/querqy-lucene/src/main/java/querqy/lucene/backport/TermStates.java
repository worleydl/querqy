package querqy.lucene.backport;
...
public final class TermStates {
    ...
    private static TermsEnum loadTermsEnum(AtomicReaderContext ctx, Term term) throws IOException {
     ...
     *
     * @param ctx
     *          the {@link AtomicReaderContext} to get the {@link TermState} for.
     * @return the {@link TermState} for the given readers ord or <code>null</code> if no
     *         {@link TermState} for the reader was registered
     */
    public TermState get(AtomicReaderContext ctx) throws IOException {
